...
- [ ] Le module accepte une **limite d'offres à noter** (`--limite N`) et sait faire des **appels directs** sans Batches.
      ⚠️ **Décidé le 26 août 2026 : premier essai sur 5 offres**, puis 50, puis le reste. Pas pour le coût — noter les 373 revient à **1,35 $ une seule fois** — mais pour pouvoir relire chaque notation en entier et juger l'étalonnage. Les Batches mettant jusqu'à une heure à rendre leurs résultats, un essai à 5 offres **doit** passer en direct, sinon chaque itération sur le prompt coûte une heure d'attente.
...
- [ ] **L'échantillon d'essai : les 5 offres les plus récentes non notées.** Décidé le 26 août 2026. Assez petit pour relire chaque note et chaque justification en entier — c'est le seul moyen de voir un étalonnage qui dérive avant d'en produire des centaines
