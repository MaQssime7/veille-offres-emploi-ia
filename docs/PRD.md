...
| ✅ **Jauge de consommation du jour — LIVRÉE en phase 7**, le 31 août 2026, le jour même de sa demande | Sur la fiche d'une offre, près du bouton d'enrichissement, et là seulement | **Deux décisions prises en la construisant** : la barre montre **deux segments**, parce qu'un enrichissement en vol réserve 150 000 tokens avant d'en dépenser un seul et qu'un total unique bondirait à 50 % au clic · et **pas de décompte avant minuit**, la page étant rendue côté serveur — « remise à zéro à minuit » est vrai sans horloge |
